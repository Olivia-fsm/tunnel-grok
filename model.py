...
class GPTBase(nn.Module):
    ...
    def forward(self, 
        ...
        return {'logits': logits, 'loss': loss, 'token_loss': token_loss, 'token_mask': token_mask, 'layer_reps': layer_reps}
    ...
    def from_pretrained(self, ckpt_path, override_args=None):
    ...
    def get_parameter_group_specs(self):
        ...
        union_params = decay | no_decay | dw
        ...
        return [
            ...
            {"params": sorted(list(dw)), "weight_decay": 0.0},
