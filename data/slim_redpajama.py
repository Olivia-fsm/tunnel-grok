...
def get_slim_redpajama(subset='arxiv', num_proc=40):
    ...
    # }
    SLIM_DATA_PATH = os.path.join(os.path.dirname(__file__), "/scratch/homes/pagliard/curriculum/src/data/datasets/slim_redpajama")
    ...
    if not os.path.exists(os.path.join(SUBSET_PATH, 'val.bin')):
        ...
        # dataset = dataset.filter(lambda example: example["meta"]["redpajama_set_name"]==SUBSET2META[subset])
...
def get_slim_redpajama_6b(subset='arxiv', num_proc=40):
    ...
    REDPAJIMA_DATA_PATH = "/mloraw1/sfan/curriculum-new/src/data/datasets/slim_6b"
