...
DATA_DIR = '/mloraw1/sfan/curriculum-new/src/data/datasets/redpajama_sampled'
SRC_FILE_MAPPINGS = {
...
# REDPAJAMA_SAMPLED_PATH = os.path.join(os.path.dirname(__file__), "datasets/redpajama_sampled/")
REDPAJAMA_SAMPLED_PATH = os.path.join("/mloraw1/sfan/curriculum-new/src/data", "datasets/redpajama_sampled/")
tknzr = tiktoken.get_encoding("gpt2")
def get_redpajama_subset(subset='arxiv', num_proc=40, 
